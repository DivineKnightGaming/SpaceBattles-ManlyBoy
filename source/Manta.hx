...
{	
	...
	public function new()
	{
		...
		y = FlxG.random.int(0,Std.int(128-height));		
		...
		velocity.y = FlxG.random.sign() * FlxG.random.int(30,50);
		velocity.x = sign * FlxG.random.int(30, 50);
